...
<div class="px-3 py-4">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 detail-header gap-4">
        ...
        <div class="flex flex-col sm:flex-row gap-2">
            <a href="{{ route('guru.nilai.show', $kelas->id) }}?action=detail" class="bg-gray-100 hover:bg-gray-200 text-gray-700 py-2 px-4 rounded-lg transition-colors text-center">
