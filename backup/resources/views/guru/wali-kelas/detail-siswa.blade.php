                                ...
                                <div class="p-6">
                                    <div class="flex items-center justify-between mb-4">
                                        <div class="flex items-center">
                                            ...
                                            <h4 class="text-lg font-medium text-gray-800">Galeri Foto Siswa</h4>
                                        </div>
                                        <button type="button" class="bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition-all flex items-center">
                                    ...
                                    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                                        ...
                                        <div class="col-span-full text-center py-12">
                                            ...
                                            <p class="text-gray-500 mb-2">Belum ada foto yang diupload</p>
                                            <p class="text-sm text-gray-400">Klik tombol "Tambah Foto" untuk menambahkan foto siswa</p>
                                        </div>
                                        @endforelse
                                    </div>
                                </div>
                            ...
                            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                                <div class="p-6">
                                    <div class="flex items-center mb-4">
                                        ...
                                        <h4 class="text-lg font-medium text-gray-800">Prestasi & Penghargaan</h4>
                                    </div>
                                    
                                    <div class="space-y-4">
                                        @forelse($siswa->prestasi ?? [] as $prestasi)
                                        <div class="flex items-start space-x-4 p-4 bg-yellow-50 rounded-lg border border-yellow-200">
                                            <div class="flex-shrink-0">
                                                <i class="fas fa-medal text-yellow-600 text-lg"></i>
                                            </div>
                                            <div class="flex-1">
                                                <h5 class="font-medium text-gray-800">{{ $prestasi->nama_prestasi }}</h5>
                                                <p class="text-sm text-gray-600 mb-1">{{ $prestasi->kategori }} - {{ $prestasi->tingkat }}</p>
                                                <p class="text-sm text-gray-500">
                                                    <i class="fas fa-calendar text-gray-400 mr-1"></i>
                                                    {{ $prestasi->tanggal ? \Carbon\Carbon::parse($prestasi->tanggal)->format('d/m/Y') : 'Tanggal tidak diketahui' }}
                                                </p>
                                                @if($prestasi->keterangan)
                                                <p class="text-sm text-gray-600 mt-2">{{ $prestasi->keterangan }}</p>
                                                @endif
                                            </div>
                                            <div class="flex-shrink-0">
                                                <span class="px-3 py-1 bg-yellow-100 text-yellow-800 text-xs font-medium rounded-full">
                                                    {{ $prestasi->peringkat ?? 'Partisipan' }}
                                                </span>
                                            </div>
                                        </div>
                                        @empty
                                        <div class="text-center py-8">
                                            ...
                                            <p class="text-gray-500 mb-1">Belum ada prestasi yang tercatat</p>
                                            <p class="text-sm text-gray-400">Prestasi siswa akan ditampilkan di sini</p>
                                        </div>
                                        @endforelse
                                    </div>
                                </div>
