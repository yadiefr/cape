                ...
                <div class="flex-shrink-0 flex items-center justify-between p-4 border-b border-gray-100">
                    <div class="flex items-center space-x-4">
                        <div class="relative">
                            ...
                            @endphp
                            @if($fotoProfil)
                                <img class="h-10 w-10 rounded-full border-2 border-blue-500 object-cover" src="{{ $fotoProfil }}" alt="{{ $namaSiswa }}">
                            @elseif($initials)
                                <div class="h-10 w-10 rounded-full border-2 border-blue-500 bg-blue-100 flex items-center justify-center font-bold text-blue-700 text-lg">{{ $initials }}</div>
                            @else
                        ...
                        <div class="min-w-0 flex-1">
                            <p class="text-sm font-medium text-gray-900 truncate">{{ Auth::guard('siswa')->user()->nama_lengkap ?? 'Siswa' }}</p>
                    ...
                    <div class="p-4 space-y-8 pb-12">
                        ...
                        <div class="space-y-2">
                            <a href="{{ route('siswa.dashboard') }}" 
                               ...
                               {{ request()->routeIs('siswa.dashboard') ? 'bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-sm' : 'text-gray-700 hover:bg-blue-50' }}">
                                <div class="flex items-center justify-center w-8 h-8 {{ request()->routeIs('siswa.dashboard') ? 'bg-white/20 text-white' : 'bg-blue-100 text-blue-600 group-hover:bg-blue-200' }} rounded-lg transition-colors mr-3">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="space-y-1">
                                <a href="{{ route('siswa.jadwal.index') }}" 
                                   class="mobile-interactive mobile-nav-item flex items-center px-4 py-3 text-sm font-medium rounded-xl transition-all duration-200 group
                                   {{ request()->routeIs('siswa.jadwal.*') ? 'bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-sm' : 'text-gray-700 hover:bg-blue-50' }}">
                                    <div class="flex items-center justify-center w-8 h-8 {{ request()->routeIs('siswa.jadwal.*') ? 'bg-white/20 text-white' : 'bg-green-100 text-green-600 group-hover:bg-green-200' }} rounded-lg transition-colors mr-3">
                                ...
                                <a href="{{ route('siswa.materi.index') }}" 
                                   class="mobile-interactive mobile-nav-item flex items-center px-4 py-3 text-sm font-medium rounded-xl transition-all duration-200 group
                                   {{ request()->routeIs('siswa.materi.*') ? 'bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-sm' : 'text-gray-700 hover:bg-blue-50' }}">
                                    <div class="flex items-center justify-center w-8 h-8 {{ request()->routeIs('siswa.materi.*') ? 'bg-white/20 text-white' : 'bg-yellow-100 text-yellow-600 group-hover:bg-yellow-200' }} rounded-lg transition-colors mr-3">
                                ...
                                <a href="{{ route('siswa.nilai.index') }}" 
                                   class="mobile-interactive mobile-nav-item flex items-center px-4 py-3 text-sm font-medium rounded-xl transition-all duration-200 group
                                   {{ request()->routeIs('siswa.nilai.*') ? 'bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-sm' : 'text-gray-700 hover:bg-blue-50' }}">
                                    <div class="flex items-center justify-center w-8 h-8 {{ request()->routeIs('siswa.nilai.*') ? 'bg-white/20 text-white' : 'bg-purple-100 text-purple-600 group-hover:bg-purple-200' }} rounded-lg transition-colors mr-3">
                                ...
                                <a href="{{ route('siswa.ujian.index') }}" 
                                   class="mobile-interactive mobile-nav-item flex items-center px-4 py-3 text-sm font-medium rounded-xl transition-all duration-200 group
                                   {{ request()->routeIs('siswa.ujian.*') ? 'bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-sm' : 'text-gray-700 hover:bg-blue-50' }}">
                                    <div class="flex items-center justify-center w-8 h-8 {{ request()->routeIs('siswa.ujian.*') ? 'bg-white/20 text-white' : 'bg-red-100 text-red-600 group-hover:bg-red-200' }} rounded-lg transition-colors mr-3">
                                ...
                                <a href="{{ route('siswa.absensi') }}" 
                                   class="mobile-interactive mobile-nav-item flex items-center px-4 py-3 text-sm font-medium rounded-xl transition-all duration-200 group
                                   {{ request()->routeIs('siswa.absensi*') ? 'bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-sm' : 'text-gray-700 hover:bg-blue-50' }}">
                                    <div class="flex items-center justify-center w-8 h-8 {{ request()->routeIs('siswa.absensi*') ? 'bg-white/20 text-white' : 'bg-orange-100 text-orange-600 group-hover:bg-orange-200' }} rounded-lg transition-colors mr-3">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="space-y-1">
                                <a href="{{ route('siswa.keuangan.index') }}" 
                                   class="mobile-interactive mobile-nav-item flex items-center px-4 py-3 text-sm font-medium rounded-xl transition-all duration-200 group
                                   {{ request()->routeIs('siswa.keuangan.*') ? 'bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-sm' : 'text-gray-700 hover:bg-blue-50' }}">
                                    <div class="flex items-center justify-center w-8 h-8 {{ request()->routeIs('siswa.keuangan.*') ? 'bg-white/20 text-white' : 'bg-blue-100 text-blue-600 group-hover:bg-blue-200' }} rounded-lg transition-colors mr-3">
                        ...
                        @endphp
                        @if($currentSiswa && ($currentSiswa->is_ketua_kelas || $currentSiswa->is_bendahara))
                        <div class="space-y-3">
                            <p class="px-4 text-xs font-bold text-gray-500 uppercase tracking-wider">Role Khusus</p>
                            <div class="space-y-1">
                                @if($currentSiswa->is_ketua_kelas)
                                <div x-data="{ openKM: false }" class="relative">
                                    <button @click="openKM = !openKM" 
                                           ...
                                           {{ request()->routeIs('siswa.ketua-kelas.*') ? 'bg-gradient-to-r from-purple-500 to-purple-600 text-white shadow-sm' : 'text-gray-700 hover:bg-purple-50' }}">
                                        <div class="flex items-center">
                                            <div class="flex items-center justify-center w-8 h-8 {{ request()->routeIs('siswa.ketua-kelas.*') ? 'bg-white/20 text-white' : 'bg-purple-100 text-purple-600 group-hover:bg-purple-200' }} rounded-lg transition-colors mr-3">
                                    ...
                                    <div x-show="openKM" class="ml-4 mt-2 space-y-1">
                                        <a href="{{ route('siswa.ketua-kelas.dashboard') }}" 
                                ...
                                @if($currentSiswa->is_bendahara)
                                <a href="{{ route('siswa.bendahara.dashboard') }}" 
                                   class="mobile-interactive mobile-nav-item flex items-center px-4 py-3 text-sm font-medium rounded-xl transition-all duration-200 group
                                   {{ request()->routeIs('siswa.bendahara.*') ? 'bg-gradient-to-r from-green-500 to-green-600 text-white shadow-sm' : 'text-gray-700 hover:bg-green-50' }}">
                                    <div class="flex items-center justify-center w-8 h-8 {{ request()->routeIs('siswa.bendahara.*') ? 'bg-white/20 text-white' : 'bg-green-100 text-green-600 group-hover:bg-green-200' }} rounded-lg transition-colors mr-3">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="space-y-1">
                                <a href="{{ route('siswa.pengumuman.index') }}" 
                                   class="mobile-interactive mobile-nav-item flex items-center px-4 py-3 text-sm font-medium rounded-xl transition-all duration-200 group
                                   {{ request()->routeIs('siswa.pengumuman.*') ? 'bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-sm' : 'text-gray-700 hover:bg-blue-50' }}">
                                    <div class="flex items-center justify-center w-8 h-8 {{ request()->routeIs('siswa.pengumuman.*') ? 'bg-white/20 text-white' : 'bg-red-100 text-red-600 group-hover:bg-red-200' }} rounded-lg transition-colors mr-3">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="space-y-1">
                                <a href="{{ route('siswa.profile.index') }}" 
                                   class="mobile-interactive mobile-nav-item flex items-center px-4 py-3 text-sm font-medium rounded-xl transition-all duration-200 group
                                   {{ request()->routeIs('siswa.profile.*') ? 'bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-sm' : 'text-gray-700 hover:bg-blue-50' }}">
                                    <div class="flex items-center justify-center w-8 h-8 {{ request()->routeIs('siswa.profile.*') ? 'bg-white/20 text-white' : 'bg-blue-100 text-blue-600 group-hover:bg-blue-200' }} rounded-lg transition-colors mr-3">
                ...
                <div class="px-4 sm:px-6 py-3 flex justify-between items-center h-full">
                    <div class="flex items-center flex-1 min-w-0">
                        ...
                        <div class="lg:hidden flex items-center ml-2 text-xs sm:text-sm text-gray-600 flex-shrink-0">
                            ...
                            <span class="inline">{{ now()->format('d/m/Y') }}</span>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center space-x-2 sm:space-x-4 flex-shrink-0">
                        ...
                        <div class="hidden md:flex items-center text-sm px-3 py-1.5 bg-gray-50 rounded-lg">
                            <a href="{{ route('siswa.dashboard') }}" class="text-blue-600 font-medium">Dashboard</a>
                     ...
                     <div x-data="{ open: false }" class="relative">
                        <button @click="open = !open" class="flex items-center space-x-1 sm:space-x-2 focus:outline-none" id="user-menu-button">
                            ...
                            <div class="h-8 w-8 sm:h-10 sm:w-10 rounded-full ring-2 ring-blue-500 p-0.5 bg-white overflow-hidden flex-shrink-0">
                                ...
                                @endphp
                                @if($fotoProfil)
                                    <img src="{{ $fotoProfil }}" class="h-full w-full rounded-full object-cover" alt="{{ $namaSiswa }}">
                                @elseif($initials)
                                    <div class="h-full w-full rounded-full bg-blue-100 flex items-center justify-center font-bold text-blue-700 text-base">{{ $initials }}</div>
                                @else
                    ...
                    <!-- User Dropdown Menu -->
                        <div x-show="open" x-cloak
                            ...
                            class="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-lg z-50 py-2 border border-gray-100">
                                <a href="{{ route('siswa.profile.index') }}" class="block px-4 py-2.5 text-sm text-gray-700 hover:bg-blue-50 group">
            ...
            <main class="flex-1 bg-gray-100 p-3 sm:p-4 lg:p-6 mt-10 transition-all duration-300 ease-in-out"
                ...
                <div class="main-content-container transition-all duration-300 origin-right w-full min-h-full overflow-visible"
                    ...
                    <div class="mb-4 bg-green-50 border-l-4 border-green-500 text-green-700 p-3 sm:p-4 rounded-r-lg shadow-sm flex items-center" role="alert" x-data="{show: true}" x-show="show" x-transition x-init="setTimeout(() => show = false, 5000)">
                        ...
                        <div class="flex-grow text-sm">{{ session('success') }}</div>
                    ...
                    <div class="mb-4 bg-red-50 border-l-4 border-red-500 text-red-700 p-3 sm:p-4 rounded-r-lg shadow-sm flex items-center" role="alert" x-data="{show: true}" x-show="show" x-transition x-init="setTimeout(() => show = false, 5000)">
                        ...
                        <div class="flex-grow text-sm">{{ session('error') }}</div>
