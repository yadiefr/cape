            ...
            <div class="bg-white rounded-xl shadow-sm">
                ...
                <div class="p-4">
                    <div class="space-y-3">
                        ...
                        <div class="flex items-start justify-between p-3 bg-blue-50 rounded-lg">
                            <div class="flex items-start flex-1">
                                ...
                                <div class="flex-1 min-w-0">
                                    <h4 class="text-sm font-medium text-gray-900 truncate">{{ $jadwal->mapel->nama ?? 'Mata Pelajaran' }}</h4>
                                    ...
                                    <div class="flex items-center mt-1">
                                        <div class="flex items-center justify-center w-4 h-4 bg-blue-500 text-white rounded-full text-xs mr-1">
            ...
            <div class="bg-white rounded-xl shadow-sm">
                ...
                <div class="p-4 md:p-6">
                    <div class="space-y-3">
                        ...
                        <div class="flex items-start justify-between p-3 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors">
                            <div class="flex items-start">
                                ...
                                <div class="flex flex-col items-center mr-3">
                                    <div class="w-3 h-3 {{ $statusClass }} rounded-full"></div>
                                    <div class="w-0.5 h-full {{ $statusClass }} bg-opacity-30 mt-1"></div>
                                </div>
                                <div>
                                    <h4 class="text-sm font-medium text-gray-900">{{ $jadwal->mapel->nama ?? 'Mata Pelajaran' }}</h4>
                                    <p class="text-xs text-gray-600">
                                        {{ $jadwal->jam_mulai }} - {{ $jadwal->jam_selesai }}
                                        @if($jadwal->jam_count > 1)
                                        <span class="text-blue-600 font-medium">({{ $jadwal->jam_count }} JP)</span>
                                    ...
                                    @if ($jadwal->guru && $jadwal->guru->nama)
                                    <div class="flex items-center mt-1">
                                        <div class="flex items-center justify-center w-5 h-5 bg-blue-500 text-white rounded-full text-xs mr-1">
                                            {{ substr($jadwal->guru->nama, 0, 1) }}
                                        </div>
                                        <p class="text-xs text-gray-700">{{ $jadwal->guru->nama }}</p>
                                    </div>
                                    @endif
                                </div>
                            </div>
        ...
        <div class="bg-white rounded-xl shadow-sm overflow-hidden">
            ...
            <div class="p-4 md:p-6">
                <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-4">
                    <a href="{{ route('siswa.jadwal.index') }}" 
                       class="flex flex-col items-center p-4 bg-blue-50 hover:bg-blue-100 rounded-xl transition-colors text-center">
                    ...
                    <a href="{{ route('siswa.materi.index') }}" 
                       class="flex flex-col items-center p-4 bg-green-50 hover:bg-green-100 rounded-xl transition-colors text-center">
                        ...
                        <span class="text-sm font-medium text-gray-900">Materi</span>
                    </a>
                    ...
                    <a href="{{ route('siswa.keuangan.index') }}" 
                       class="flex flex-col items-center p-4 bg-yellow-50 hover:bg-yellow-100 rounded-xl transition-colors text-center">
                        ...
                        <span class="text-sm font-medium text-gray-900">Keuangan</span>
                    </a>
                </div>
            </div>
        </div>
