...
<div class="container mx-auto py-8 px-4">
    <div class="max-w-5xl mx-auto bg-white shadow-md rounded-lg overflow-hidden">
        <div class="px-6 py-4 bg-blue-600 text-white">
            ...
            <p class="text-sm">Tahun Ajaran {{ $ppdb_year }}</p>
            <p class="text-sm mt-1">Periode Pendaftaran: {{ \Carbon\Carbon::parse($ppdb_start_date)->format('d F Y') }} - {{ \Carbon\Carbon::parse($ppdb_end_date)->format('d F Y') }}</p>
        </div>
        ...
        <form action="{{ route('pendaftaran.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
            @csrf            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="mt-1 flex rounded-md shadow-sm">
                            ...
                            <input type="text" name="nisn" id="nisn" value="{{ old('nisn') }}" required pattern="[0-9]{10}"
                                class="flex-1 min-w-0 block w-full border-gray-300 rounded-none rounded-r-md focus:ring-blue-500 focus:border-blue-500">
                        </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="mt-1 flex rounded-md shadow-sm">
                            ...
                            <textarea name="alamat" id="alamat" rows="3" required 
                                class="flex-1 min-w-0 block w-full border-gray-300 rounded-none rounded-r-md focus:ring-blue-500 focus:border-blue-500">{{ old('alamat') }}</textarea>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="mt-1 flex rounded-md shadow-sm">
                            ...
                            <input type="tel" name="telepon_orangtua" id="telepon_orangtua" value="{{ old('telepon_orangtua') }}" required
                                class="flex-1 min-w-0 block w-full border-gray-300 rounded-none rounded-r-md focus:ring-blue-500 focus:border-blue-500">
                        </div>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="mt-1 flex rounded-md shadow-sm">
                            ...
                            <textarea name="alamat_orangtua" id="alamat_orangtua" rows="3"
                                class="flex-1 min-w-0 block w-full border-gray-300 rounded-none rounded-r-md focus:ring-blue-500 focus:border-blue-500">{{ old('alamat_orangtua') }}</textarea>
                        </div>
            ...
            <div class="mb-6">                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
                        ...
                        <div class="mt-1 flex rounded-md shadow-sm">
                            ...
                            <select name="pilihan_jurusan_1" id="pilihan_jurusan_1" required
                                ...
                                @foreach($jurusan as $j)
                                    <option value="{{ $j->id }}" {{ old('pilihan_jurusan_1') == $j->id ? 'selected' : '' }}>{{ $j->nama_jurusan }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <div class="mt-1 flex rounded-md shadow-sm">
                                    ...
                                    <input type="number" name="nilai_matematika" id="nilai_matematika" value="{{ old('nilai_matematika') }}" min="0" max="100" step="0.01"
                                        class="flex-1 min-w-0 block w-full border-gray-300 rounded-none rounded-r-md focus:ring-blue-500 focus:border-blue-500">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="mt-1 flex rounded-md shadow-sm">
                                    ...
                                    <input type="number" name="nilai_indonesia" id="nilai_indonesia" value="{{ old('nilai_indonesia') }}" min="0" max="100" step="0.01"
                                        class="flex-1 min-w-0 block w-full border-gray-300 rounded-none rounded-r-md focus:ring-blue-500 focus:border-blue-500">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="mt-1 flex rounded-md shadow-sm">
                                    ...
                                    <input type="number" name="nilai_inggris" id="nilai_inggris" value="{{ old('nilai_inggris') }}" min="0" max="100" step="0.01"
                                        class="flex-1 min-w-0 block w-full border-gray-300 rounded-none rounded-r-md focus:ring-blue-500 focus:border-blue-500">
                                </div>
                            </div>
                        </div>
              ...
              <div class="pt-6">
                <div class="flex items-center justify-between">
                    <a href="{{ url('/') }}" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-gray-700 bg-gray-100 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
    ...
    <div class="max-w-5xl mx-auto mt-6 bg-gray-50 rounded-lg border border-gray-200 p-4 text-center">
        <p class="text-sm text-gray-600">
            Sudah mendaftar? <a href="{{ route('pendaftaran.check') }}" class="font-medium text-blue-600 hover:text-blue-500">Cek Status Pendaftaran</a>
        </p>
    </div>
</div>
@endsection
