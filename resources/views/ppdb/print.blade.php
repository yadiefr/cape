...
<body>
    <div class="container">
        ...
        <div class="subtitle" style="text-align: center; margin-top: -15px;">Tahun Ajaran {{ $pendaftaran->tahun_ajaran }}</div>
        
        <div class="reg-number">{{ $pendaftaran->nomor_pendaftaran }}</div>
        
        <div class="status {{ 
            $pendaftaran->status == 'menunggu' ? 'pending' : 
            ($pendaftaran->status == 'diterima' ? 'accepted' : 
            ($pendaftaran->status == 'ditolak' ? 'rejected' : 'waiting')) 
        }}">
            Status: {{ 
                $pendaftaran->status == 'menunggu' ? 'MENUNGGU VERIFIKASI' : 
        ...
        <div class="info-box">
            ...
            <table class="info-table">
                <tr>
                    ...
                    <td>:</td>
                    <td>{{ $pendaftaran->tanggal_pendaftaran->format('d F Y') }}</td>
                </tr>
                <tr>
                    <td>Pilihan Jurusan 1</td>
                    <td>:</td>
                    <td>{{ $pendaftaran->jurusanPertama->nama }}</td>
                </tr>
        ...
        <div class="info-box">
            ...
            <table class="info-table">
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td>{{ $pendaftaran->telepon_orangtua ?? '-' }}</td>
                </tr>
                @if($pendaftaran->alamat_orangtua)
                <tr>
        ...
        <div class="info-box">
            ...
            <table class="info-table">
                ...
                <tr>
                    <td>Matematika</td>
                    <td>:</td>
                    <td>{{ $pendaftaran->nilai_matematika }}</td>
                </tr>
                @endif
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td>{{ $pendaftaran->nilai_indonesia }}</td>
                </tr>
                @endif
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td>{{ $pendaftaran->nilai_inggris }}</td>
                </tr>
                @endif
            </table>
        </div>
        ...
        <div class="footer clearfix">
            <div class="signature">
                ...
                <p style="margin-top: 70px; font-weight: bold; text-decoration: underline;">{{ $pendaftaran->nama_lengkap }}</p>
