                ...
                <div class="card-body">
                    <?php if($isHosting): ?>
                        <div class="alert alert-info">
                            ...
                            <br>
                            <strong>Source:</strong> <?php echo e($syncStatus['base_path'] ?? '/home/smkpgric/cape'); ?>/storage/app/public/<br>
                            <strong>Target:</strong> <?php echo e(str_replace('/cape', '', $syncStatus['base_path'] ?? '/home/smkpgric')); ?>/public_html/storage/
                        </div>
