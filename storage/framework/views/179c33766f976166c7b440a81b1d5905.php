...
<?php $__env->startSection('title', 'Pengaturan - SMK PGRI CIKAMPEK'); ?>
                    ...
                    <div class="p-6">
                        <div class="space-y-6">
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-start">
                                ...
                                <div class="md:col-span-2">
                                    <input type="text" 
                                           ...
                                           value="<?php echo e($settings['nama_sekolah'] ?? 'SMK PGRI CIKAMPEK'); ?>"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-start">
                                ...
                                <div class="md:col-span-2">
                                    <textarea 
                                        ...
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"><?php echo e($settings['alamat_sekolah'] ?? ''); ?></textarea>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-start">
                                ...
                                <div class="md:col-span-2">
                                    <input type="text" 
                                           ...
                                           value="<?php echo e($settings['telepon_sekolah'] ?? ''); ?>"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-start">
                                ...
                                <div class="md:col-span-2">
                                    <input type="email" 
                                           ...
                                           value="<?php echo e($settings['email_sekolah'] ?? ''); ?>"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-start">
                                ...
                                <div class="md:col-span-2">
                                    <div class="space-y-2">                                        <?php if(isset($settings['logo_sekolah']) && !empty($settings['logo_sekolah'])): ?>
                                            <div class="mb-2">
                                                <img src="<?php echo e(asset('storage/' . $settings['logo_sekolah'])); ?>" 
                                                     alt="Logo Sekolah" 
                                                     class="h-20 w-auto object-contain border rounded"
                                                     onerror="this.onerror=null; this.src='<?php echo e(asset('images/default-logo.png')); ?>'; console.log('Logo image failed to load from: <?php echo e(asset('storage/' . $settings['logo_sekolah'])); ?>');">
                                                <p class="text-xs text-gray-500 mt-1">Current logo: <?php echo e($settings['logo_sekolah']); ?></p>
                                            </div>
                                        <?php else: ?>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-start">
                                ...
                                <div class="md:col-span-2">
                                    <input type="text" 
                                           ...
                                           value="<?php echo e($settings['site_title'] ?? 'SMK PGRI CIKAMPEK'); ?>"
                                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-start">
                                ...
                                <div class="md:col-span-2">
                                    <textarea 
                                        ...
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"><?php echo e($settings['site_description'] ?? ''); ?></textarea>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-start">
                                ...
                                <div class="md:col-span-2">
                                    <div class="space-y-2">                                        <?php
                                        ...
                                        ?>
                                        <?php if($favicon && Storage::disk('public')->exists($favicon)): ?>
                                            <div class="mb-2">
                                                <img src="<?php echo e(asset('storage/' . $favicon)); ?>" 
                                                     alt="Favicon" 
                                                     class="h-8 w-8 object-contain border rounded">
                                            </div>
                                        <?php endif; ?><input type="file" 
                                               name="site_favicon" 
                                               accept="image/*"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-start">
                                ...
                                <div class="md:col-span-2">
                                    <select name="settings[maintenance_mode][value]" 
                                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                        <option value="0" <?php echo e(($settings['maintenance_mode'] ?? '0') == '0' ? 'selected' : ''); ?>>Nonaktif</option>
                                        <option value="1" <?php echo e(($settings['maintenance_mode'] ?? '0') == '1' ? 'selected' : ''); ?>>Aktif</option>
                                    </select>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-start">
                                ...
                                <div class="md:col-span-2">
                                    <select name="settings[timezone][value]" 
                                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                        <option value="Asia/Jakarta" <?php echo e(($settings['timezone'] ?? 'Asia/Jakarta') == 'Asia/Jakarta' ? 'selected' : ''); ?>>Asia/Jakarta (WIB)</option>
                                        <option value="Asia/Makassar" <?php echo e(($settings['timezone'] ?? 'Asia/Jakarta') == 'Asia/Makassar' ? 'selected' : ''); ?>>Asia/Makassar (WITA)</option>
                                        <option value="Asia/Jayapura" <?php echo e(($settings['timezone'] ?? 'Asia/Jakarta') == 'Asia/Jayapura' ? 'selected' : ''); ?>>Asia/Jayapura (WIT)</option>
                                    </select>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-start">
                                ...
                                <div class="md:col-span-2">
                                    <select name="settings[items_per_page][value]" 
                                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                        <option value="10" <?php echo e(($settings['items_per_page'] ?? '10') == '10' ? 'selected' : ''); ?>>10</option>
                                        <option value="25" <?php echo e(($settings['items_per_page'] ?? '10') == '25' ? 'selected' : ''); ?>>25</option>
                                        <option value="50" <?php echo e(($settings['items_per_page'] ?? '10') == '50' ? 'selected' : ''); ?>>50</option>
                                        <option value="100" <?php echo e(($settings['items_per_page'] ?? '10') == '100' ? 'selected' : ''); ?>>100</option>
                                    </select>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\website-smk3\resources\views/admin/settings/index.blade.php ENDPATH**/ ?>