...
<?php $__env->startSection('title', 'Input Nilai - SMK PGRI CIKAMPEK'); ?>
...
<div class="px-3 py-4">
        ...
        <div>
            ...
            <div class="mt-2 flex flex-wrap items-center gap-2">
                <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                    ...
                    Semester <?php echo e($currentSemester); ?> (<?php echo e($currentSemester == 1 ? 'Ganjil' : 'Genap'); ?>)
                </span>
                <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800">
                    <i class="fas fa-graduation-cap mr-1"></i>
                    <?php echo e($academicYear); ?>/<?php echo e($academicYear + 1); ?>

                </span>
            </div>
        </div>
        <a href="<?php echo e(route('guru.nilai.show', $kelas->id)); ?>?action=detail&mapel_id=<?php echo e($mapel->id); ?>" class="bg-gray-100 hover:bg-gray-200 text-gray-700 py-2 px-4 rounded-lg transition-colors text-center sm:text-left">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden mb-6 nilai-form-card">
        <div class="p-2 border-b border-gray-100">
            ...
            <strong><p class="text-blue-600"><?php echo e($kelas->nama_kelas ?? 'Kelas Tidak Diketahui'); ?> - <?php echo e($mapel->nama ?? 'Mata Pelajaran Tidak Diketahui'); ?></p></strong>
        </div>

        <div class="p-5">
            <form action="<?php echo e(route('guru.nilai.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6 form-row">
                    <div>
                        ...
                        <select id="jenis_nilai" name="jenis_nilai" class="w-full rounded-lg border-gray-300 focus:ring-blue-500 focus:border-blue-500" required>
                            ...
                            <option value="tugas" <?php echo e($jenisNilai === 'tugas' ? 'selected' : ''); ?>>Tugas Harian</option>
                            <option value="ulangan" <?php echo e($jenisNilai === 'ulangan' ? 'selected' : ''); ?>>Ulangan Harian</option>
                            <option value="uts" <?php echo e($jenisNilai === 'uts' ? 'selected' : ''); ?>>UTS (Ujian Tengah Semester)</option>
                            <option value="uas" <?php echo e($jenisNilai === 'uas' ? 'selected' : ''); ?>>UAS (Ujian Akhir Semester)</option>
                            <option value="praktik" <?php echo e($jenisNilai === 'praktik' ? 'selected' : ''); ?>>Praktik/Praktek</option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <select id="semester" name="semester" class="w-full rounded-lg border-gray-300 focus:ring-blue-500 focus:border-blue-500" required>
                            ...
                            <option value="1" <?php echo e($currentSemester == 1 ? 'selected' : ''); ?>>Semester 1 (Ganjil)</option>
                            <option value="2" <?php echo e($currentSemester == 2 ? 'selected' : ''); ?>>Semester 2 (Genap)</option>
                        </select>
                    ...
                    <div>
                        ...
                        <select id="tahun_ajaran" name="tahun_ajaran" class="w-full rounded-lg border-gray-300 focus:ring-blue-500 focus:border-blue-500" required>
                            <option value="<?php echo e($academicYear); ?>" selected><?php echo e($academicYear); ?>/<?php echo e($academicYear + 1); ?></option>
                            <option value="<?php echo e($academicYear - 1); ?>"><?php echo e($academicYear - 1); ?>/<?php echo e($academicYear); ?></option>
                            <option value="<?php echo e($academicYear + 1); ?>"><?php echo e($academicYear + 1); ?>/<?php echo e($academicYear + 2); ?></option>
                        </select>
                        <p class="text-xs text-gray-500 mt-1">
                            <i class="fas fa-calendar mr-1"></i>
                            Tahun ajaran saat ini: <?php echo e($academicYear); ?>/<?php echo e($academicYear + 1); ?>
                    ...
                    <table class="w-full">
                        ...
                        <tbody>
                            ...
                            <tr class="border-b last:border-b-0 hover:bg-gray-50 siswa-row">
                                <td class="py-3 px-4 text-gray-800"><?php echo e($index + 1); ?></td>
                                <td class="py-3 px-4 text-gray-800"><?php echo e($s->nis); ?></td>
                                <td class="py-3 px-4 text-gray-800"><?php echo e($s->nama_lengkap); ?></td>
                                <td class="py-3 px-4">
                                    <input type="hidden" name="siswa_id[]" value="<?php echo e($s->id); ?>">
                            ...
                            <div class="flex items-center justify-between mb-2">
                                <div class="flex items-center flex-1 min-w-0">
                                    ...
                                    <div class="min-w-0 flex-1">
                                        ...
                                        <p class="text-xs text-gray-500"><?php echo e($s->nis); ?></p>
                                        <input type="hidden" name="siswa_id[]" value="<?php echo e($s->id); ?>">
                                    </div>
                                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('Current Month:', <?php echo e(date('n')); ?>);
    console.log('Selected Semester:', <?php echo e($currentSemester); ?>);
    console.log('Academic Year:', '<?php echo e($academicYear); ?>/<?php echo e($academicYear + 1); ?>');
...
<?php echo $__env->make('layouts.guru', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\website-smk3\resources\views/guru/nilai/create.blade.php ENDPATH**/ ?>