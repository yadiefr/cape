...
<?php $__env->startSection('title', $galeri->judul . ' - Galeri - ' . setting('nama_sekolah', 'SMK PGRI CIKAMPEK')); ?>

<?php $__env->startSection('meta_description', $galeri->deskripsi); ?>
    ...
    <div class="container mx-auto px-4">
        ...
        <nav class="mb-8">
            <div class="flex items-center space-x-2 text-sm text-gray-600">
                ...
                <span>/</span>
                <a href="<?php echo e(route('galeri.index')); ?>" class="hover:text-blue-600 transition-colors">Galeri</a>
                <span>/</span>
                <span class="text-gray-800 font-medium"><?php echo e($galeri->judul); ?></span>
            </div>
        </nav>
        ...
        <div class="bg-white rounded-xl shadow-lg p-8 mb-8">
            <div class="text-center">
                <h1 class="text-3xl md:text-4xl font-bold text-gray-800 mb-4"><?php echo e($galeri->judul); ?></h1>
                <p class="text-lg text-gray-600 max-w-3xl mx-auto mb-6"><?php echo e($galeri->deskripsi); ?></p>
                ...
                <div class="flex flex-wrap items-center justify-center gap-4 text-sm text-gray-500">
                    <div class="flex items-center">
                        ...
                        <span class="px-3 py-1 bg-blue-100 text-blue-600 rounded-full">
                            <?php echo e(ucfirst(str_replace(['_', '-'], ' ', $galeri->kategori))); ?>

                        </span>
                    </div>
                    <div class="flex items-center">
                        <i class="fas fa-calendar-alt mr-2"></i>
                        <?php echo e($galeri->created_at->format('d F Y')); ?>

                    </div>
                    <div class="flex items-center">
                        <i class="fas fa-images mr-2"></i>
                        <?php echo e($galeri->foto->count()); ?> Foto
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    function sharePhoto() {
        if (navigator.share) {
            navigator.share({
                title: '<?php echo e($galeri->judul); ?>',
                text: '<?php echo e($galeri->deskripsi); ?>',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\website-smk3\resources\views/galeri/show.blade.php ENDPATH**/ ?>