...
<?php $__env->startSection('title', 'Manajemen Bel Sekolah'); ?>

<?php $__env->startPush('styles'); ?>
<link href="<?php echo e(asset('css/bel-management.css')); ?>" rel="stylesheet">
<?php $__env->stopPush(); ?>

<?php $__env->startPush('scripts'); ?>
<script src="<?php echo e(asset('js/direct-clock.js')); ?>?v=<?php echo e(time()); ?>"></script>
<?php $__env->stopPush(); ?>
...
<div class="container-fluid px-4">
        ...
        <div class="relative z-10">
                ...
                <div class="flex items-center space-x-3">
                    <div id="live-clock" class="bg-gradient-to-r from-gray-800 to-gray-700 text-white px-4 py-2 rounded-lg font-mono flex flex-col items-center shadow-md border border-gray-700">
                        <div class="flex items-center">
                            ...
                            <span id="clock-time" class="tracking-wider text-xl"><?php echo e(date('H:i:s')); ?></span>
                        </div>
                        <div class="text-xs text-gray-300 mt-1 text-center" id="current-day"><?php echo e(date('l') === 'Monday' ? 'Senin' : (date('l') === 'Tuesday' ? 'Selasa' : (date('l') === 'Wednesday' ? 'Rabu' : (date('l') === 'Thursday' ? 'Kamis' : (date('l') === 'Friday' ? 'Jumat' : (date('l') === 'Saturday' ? 'Sabtu' : 'Minggu')))))); ?></div>
                    </div>
                    <span class="bg-blue-100 text-blue-600 px-3 py-1 rounded-full text-sm">
                        <?php echo e($dailyBels->count()); ?> jadwal
                    </span>
                </div>
            </div>
            
            <?php if($dailyBels->count() > 0): ?>
            <div class="overflow-x-auto">
                <table class="w-full rounded-lg overflow-hidden">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $dailyBels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="border-b hover:bg-gray-50" id="row-<?php echo e($bel->id); ?>">
                            <td class="py-3 px-4">
                                <div class="flex items-center">
                                    <div class="w-10 h-10 rounded-lg bg-<?php echo e(str_replace('#', '', $bel->kode_warna)); ?>-100 flex items-center justify-center mr-3">
                                        <i class="fas fa-<?php echo e($bel->ikon); ?> text-<?php echo e(str_replace('#', '', $bel->kode_warna)); ?>-500"></i>
                                    </div>
                                    <div>
                                        <p class="font-medium"><?php echo e($bel->nama); ?></p>
                                        <?php if($bel->deskripsi): ?>
                                        <p class="text-xs text-gray-500"><?php echo e($bel->deskripsi); ?></p>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </td>
                            <td class="py-3 px-4 font-medium"><?php echo e(date('H:i', strtotime($bel->waktu))); ?></td>
                            <td class="py-3 px-4">
                            ...
                            <td class="py-3 px-4 text-center">
                                <div class="flex justify-center space-x-2">
                                    <a href="<?php echo e(route('admin.bel.edit', $bel->id)); ?>" class="bg-amber-100 text-amber-600 p-2 rounded-lg hover:bg-amber-200 transition-colors">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <button type="button" onclick="toggleAktif(<?php echo e($bel->id); ?>)" class="bg-blue-100 text-blue-600 p-2 rounded-lg hover:bg-blue-200 transition-colors" id="toggle-btn-<?php echo e($bel->id); ?>">
                                        <?php if($bel->aktif): ?>
                                    ...
                                    <button type="button" onclick="bunyikanBel(<?php echo e($bel->id); ?>, '<?php echo e(addslashes($bel->nama)); ?>')" class="bg-green-100 text-green-600 p-2 rounded-lg hover:bg-green-200 transition-colors">
                                        <i class="fas fa-bell"></i>
                                    </button>
                                    <button type="button" onclick="hapusBel(<?php echo e($bel->id); ?>, '<?php echo e(addslashes($bel->nama)); ?>')" class="bg-red-100 text-red-600 p-2 rounded-lg hover:bg-red-200 transition-colors">
            ...
            <div class="text-center py-6 bg-gray-50 rounded-lg">
                ...
                <a href="<?php echo e(route('admin.bel.create')); ?>" class="mt-3 inline-block text-blue-600 hover:underline">Tambah jadwal bel</a>
            </div>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm p-6 mb-6 relative overflow-hidden">
        <div class="bg-gradient-to-br from-<?php echo e($loop->index % 2 == 0 ? 'purple' : 'cyan'); ?>-50 to-<?php echo e($loop->index % 2 == 0 ? 'indigo' : 'blue'); ?>-50 absolute inset-0 opacity-50"></div>
        <div class="relative z-10">
            <div class="flex justify-between items-center mb-4">
                <h3 class="text-lg font-semibold text-gray-800 flex items-center">
                    <span class="bg-<?php echo e($loop->index % 2 == 0 ? 'purple' : 'cyan'); ?>-100 text-<?php echo e($loop->index % 2 == 0 ? 'purple' : 'cyan'); ?>-600 p-2 rounded-lg mr-2">
                        <i class="fas fa-calendar-day"></i>
                    </span>
                    Jadwal Bel Hari <?php echo e($dayName); ?>

                </h3>
                <span class="bg-<?php echo e($loop->index % 2 == 0 ? 'purple' : 'cyan'); ?>-100 text-<?php echo e($loop->index % 2 == 0 ? 'purple' : 'cyan'); ?>-600 px-3 py-1 rounded-full text-sm">
                    <?php echo e($groupedBels->get($day, collect())->count()); ?> jadwal
                </span>
            </div>
            
            <?php if($groupedBels->get($day, collect())->count() > 0): ?>
            <div class="overflow-x-auto">
                <table class="w-full rounded-lg overflow-hidden">
                    <thead class="bg-gradient-to-r from-<?php echo e($loop->index % 2 == 0 ? 'purple' : 'cyan'); ?>-500 to-<?php echo e($loop->index % 2 == 0 ? 'indigo' : 'blue'); ?>-600 text-white">
                        <tr>
                            <th class="py-3 px-4 text-left">Nama Bel</th>
                            <th class="py-3 px-4 text-left">Waktu</th>
                            <th class="py-3 px-4 text-left">Tipe</th>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $groupedBels->get($day, collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="border-b hover:bg-gray-50" id="row-<?php echo e($bel->id); ?>">
                            <td class="py-3 px-4">
                                <div class="flex items-center">
                                    <div class="w-10 h-10 rounded-lg bg-<?php echo e(str_replace('#', '', $bel->kode_warna)); ?>-100 flex items-center justify-center mr-3">
            ...
            <div class="text-center py-6 bg-gray-50 rounded-lg">
                <i class="fas fa-bell-slash text-gray-400 text-4xl mb-3"></i>
                <p class="text-gray-500">Tidak ada jadwal bel untuk hari <?php echo e($dayName); ?>.</p>
                <a href="<?php echo e(route('admin.bel.create')); ?>" class="mt-3 inline-block text-blue-600 hover:underline">Tambah jadwal bel</a>
            </div>
            <?php endif; ?>
        </div>
...
<script src="<?php echo e(asset('js/bel-management.js')); ?>?v=<?php echo e(time()); ?>"></script>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\website-smk3\resources\views\admin\bel\index.blade.php ENDPATH**/ ?>