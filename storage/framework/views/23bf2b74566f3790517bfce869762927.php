...
<?php $__env->startSection('title', 'Data Siswa - SMK PGRI CIKAMPEK'); ?>
...
<div class="container-responsive">
        ...
        <div class="header-card bg-white rounded-lg shadow-sm border border-gray-200 p-3 lg:p-6 hover:shadow-md transition-shadow h-20 lg:h-28 flex items-center">
            <div class="flex items-center w-full">
                ...
                <div class="ml-3 lg:ml-4 flex-grow">
                    ...
                    <p class="text-lg lg:text-2xl font-bold text-gray-900"><?php echo e(number_format($totalSiswa)); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="header-card bg-white rounded-lg shadow-sm border border-gray-200 p-3 lg:p-6 hover:shadow-md transition-shadow h-20 lg:h-28 flex items-center">
            <div class="flex items-center w-full">
                ...
                <div class="ml-3 lg:ml-4 flex-grow">
                    ...
                    <p class="text-lg lg:text-2xl font-bold text-gray-900"><?php echo e(number_format($siswaAktif)); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="header-card bg-white rounded-lg shadow-sm border border-gray-200 p-3 lg:p-6 hover:shadow-md transition-shadow h-20 lg:h-28 flex items-center">
            <div class="flex items-center w-full">
                ...
                <div class="ml-3 lg:ml-4 flex-grow">
                    ...
                    <p class="text-lg lg:text-2xl font-bold text-gray-900"><?php echo e(number_format($siswaLakiLaki)); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="header-card bg-white rounded-lg shadow-sm border border-gray-200 p-3 lg:p-6 hover:shadow-md transition-shadow h-20 lg:h-28 flex items-center">
            <div class="flex items-center w-full">
                ...
                <div class="ml-3 lg:ml-4 flex-grow">
                    ...
                    <p class="text-lg lg:text-2xl font-bold text-gray-900"><?php echo e(number_format($siswaPerempuan)); ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="filter-card bg-white rounded-lg shadow-sm border border-gray-200 mb-3 md:mb-6">
        <div class="filter-section md:p-6">
            ...
            <form method="GET" action="<?php echo e(route('guru.siswa.index')); ?>" class="filter-form space-y-2 md:space-y-4">
                        ...
                        <span>Diurutkan berdasarkan: 
                            <strong class="text-blue-600">
                                <?php if(request('sort_by') == 'nama'): ?>
                                    Nama
                                <?php elseif(request('sort_by') == 'kelas'): ?>
                                    Kelas
                                <?php elseif(request('sort_by') == 'nisn'): ?>
                                    NISN
                                <?php elseif(request('sort_by') == 'jenis_kelamin'): ?>
                                    Jenis Kelamin
                                <?php elseif(request('sort_by') == 'status'): ?>
                                    Status
                                <?php else: ?>
                                    Kelas
                                <?php endif; ?>
                            </strong>
                            <span class="ml-1 text-gray-500">(<?php echo e(request('sort_order', 'asc') == 'asc' ? 'A-Z' : 'Z-A'); ?>)</span>
                        </span>
                        <?php if(request('sort_by') || request('sort_order')): ?>
                            <a href="<?php echo e(route('guru.siswa.index', request()->except(['sort_by', 'sort_order']))); ?>" 
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                <div>
                    <h2 class="text-lg font-semibold text-gray-900 flex items-center">
                        ...
                        Daftar Siswa 
                        <span class="ml-2 text-sm text-gray-500 font-normal">(<?php echo e(count($siswa)); ?> siswa)</span>
                    </h2>
                </div>
            </div>
        </div>
                    ...
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                            <div class="flex items-center space-x-1">
                                ...
                                <div class="flex flex-col">
                                    <a href="<?php echo e(route('guru.siswa.index', array_merge(request()->all(), ['sort_by' => 'nama', 'sort_order' => 'asc']))); ?>" 
                                       class="text-gray-400 hover:text-gray-600 <?php echo e(request('sort_by') == 'nama' && request('sort_order') == 'asc' ? 'text-blue-600' : ''); ?>">
                                        <svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd" d="M14.707 12.707a1 1 0 01-1.414 0L10 9.414l-3.293 3.293a1 1 0 01-1.414-1.414l4-4a1 1 0 011.414 0l4 4a1 1 0 010 1.414z" clip-rule="evenodd"></path>
                                        </svg>
                                    </a>
                                    <a href="<?php echo e(route('guru.siswa.index', array_merge(request()->all(), ['sort_by' => 'nama', 'sort_order' => 'desc']))); ?>" 
                                       class="text-gray-400 hover:text-gray-600 <?php echo e(request('sort_by') == 'nama' && request('sort_order') == 'desc' ? 'text-blue-600' : ''); ?>">
                                        <svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                            <div class="flex items-center space-x-1">
                                <span>NIS</span>
                                <div class="flex flex-col">
                                    <a href="<?php echo e(route('guru.siswa.index', array_merge(request()->all(), ['sort_by' => 'nis', 'sort_order' => 'asc']))); ?>"
                                       class="text-gray-400 hover:text-gray-600 <?php echo e(request('sort_by') == 'nis' && request('sort_order') == 'asc' ? 'text-blue-600' : ''); ?>">
                                        <svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd" d="M14.707 12.707a1 1 0 01-1.414 0L10 9.414l-3.293 3.293a1 1 0 01-1.414-1.414l4-4a1 1 0 011.414 0l4 4a1 1 0 010 1.414z" clip-rule="evenodd"></path>
                                        </svg>
                                    </a>
                                    <a href="<?php echo e(route('guru.siswa.index', array_merge(request()->all(), ['sort_by' => 'nis', 'sort_order' => 'desc']))); ?>"
                                       class="text-gray-400 hover:text-gray-600 <?php echo e(request('sort_by') == 'nis' && request('sort_order') == 'desc' ? 'text-blue-600' : ''); ?>">
                                        <svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                                        </svg>
                                    </a>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                            <div class="flex items-center space-x-1">
                                <span class="<?php echo e((request('sort_by') == 'kelas' || (!request('sort_by') && !request('sort_order'))) ? 'text-blue-600 font-semibold' : ''); ?>">Kelas</span>
                                <div class="flex flex-col">
                                    <a href="<?php echo e(route('guru.siswa.index', array_merge(request()->all(), ['sort_by' => 'kelas', 'sort_order' => 'asc']))); ?>" 
                                       class="text-gray-400 hover:text-gray-600 <?php echo e((request('sort_by') == 'kelas' && request('sort_order') == 'asc') || (!request('sort_by') && !request('sort_order')) ? 'text-blue-600' : ''); ?>">
                                        <svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd" d="M14.707 12.707a1 1 0 01-1.414 0L10 9.414l-3.293 3.293a1 1 0 01-1.414-1.414l4-4a1 1 0 011.414 0l4 4a1 1 0 010 1.414z" clip-rule="evenodd"></path>
                                        </svg>
                                    </a>
                                    <a href="<?php echo e(route('guru.siswa.index', array_merge(request()->all(), ['sort_by' => 'kelas', 'sort_order' => 'desc']))); ?>" 
                                       class="text-gray-400 hover:text-gray-600 <?php echo e(request('sort_by') == 'kelas' && request('sort_order') == 'desc' ? 'text-blue-600' : ''); ?>">
                                        <svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                                        </svg>
                                    </a>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                            <div class="flex items-center space-x-1">
                                <span>Status</span>
                                <div class="flex flex-col">
                                    <a href="<?php echo e(route('guru.siswa.index', array_merge(request()->all(), ['sort_by' => 'status', 'sort_order' => 'asc']))); ?>" 
                                       class="text-gray-400 hover:text-gray-600 <?php echo e(request('sort_by') == 'status' && request('sort_order') == 'asc' ? 'text-blue-600' : ''); ?>">
                                        <svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd" d="M14.707 12.707a1 1 0 01-1.414 0L10 9.414l-3.293 3.293a1 1 0 01-1.414-1.414l4-4a1 1 0 011.414 0l4 4a1 1 0 010 1.414z" clip-rule="evenodd"></path>
                                        </svg>
                                    </a>
                                    <a href="<?php echo e(route('guru.siswa.index', array_merge(request()->all(), ['sort_by' => 'status', 'sort_order' => 'desc']))); ?>" 
                                       class="text-gray-400 hover:text-gray-600 <?php echo e(request('sort_by') == 'status' && request('sort_order') == 'desc' ? 'text-blue-600' : ''); ?>">
                                        <svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                                        </svg>
                                    </a>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <?php $__empty_1 = true; $__currentLoopData = $siswa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="siswa-row hover:bg-gray-50 transition-colors duration-200">
                                ...
                                <div class="flex items-center">
                                    <div class="h-10 w-10 rounded-full overflow-hidden bg-gray-100">
                                        <?php if($student->foto && Storage::disk('public')->exists($student->foto)): ?>
                                            <img src="<?php echo e(asset('storage/' . $student->foto)); ?>" alt="Foto <?php echo e($student->nama_lengkap); ?>" class="h-full w-full object-cover">
                                        <?php else: ?>
                                            <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($student->nama_lengkap)); ?>&background=3b82f6&color=ffffff" alt="Foto <?php echo e($student->nama_lengkap); ?>" class="h-full w-full object-cover">
                                        <?php endif; ?>
                                    </div>
                                    <div class="ml-4">
                                        <div class="text-sm font-medium text-gray-900"><?php echo e($student->nama_lengkap); ?></div>
                                        <div class="text-sm text-gray-500"><?php echo e($student->jenis_kelamin == 'L' ? 'Laki-laki' : 'Perempuan'); ?></div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900"><?php echo e($student->kelas->nama_kelas); ?></div>
                                <div class="text-sm text-gray-500"><?php echo e($student->kelas->jurusan->nama_jurusan); ?></div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <?php elseif($student->status == 'non-aktif'): ?>
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-100 text-red-800">
                                        Non-Aktif
                                    </span>
                                <?php elseif($student->status == 'pindah'): ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm">
                                <a href="<?php echo e(route('guru.siswa.show', $student)); ?>"
                ...
                <div class="mobile-student-card">
                    <div class="student-header">
                        <div class="student-avatar">
                            <?php if($student->foto && Storage::disk('public')->exists($student->foto)): ?>
                                <img src="<?php echo e(asset('storage/' . $student->foto)); ?>" alt="Foto <?php echo e($student->nama_lengkap); ?>" class="w-full h-full object-cover rounded-full">
                            <?php else: ?>
                                <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($student->nama_lengkap)); ?>&background=3b82f6&color=ffffff" alt="Foto <?php echo e($student->nama_lengkap); ?>" class="w-full h-full object-cover rounded-full">
                            <?php endif; ?>
                        </div>
                        <div class="student-info flex-1">
                            <h3><?php echo e($student->nama_lengkap); ?></h3>
                            <p><?php echo e($student->kelas->nama_kelas); ?> - <?php echo e($student->kelas->jurusan->nama_jurusan); ?></p>
                        </div>
                    ...
                    <div class="student-details">
                        ...
                        <div class="detail-chip">
                            ...
                            <span class="value"><?php echo e($student->tempat_lahir); ?>, <?php echo e($student->tanggal_lahir ? \Carbon\Carbon::parse($student->tanggal_lahir)->format('d/m/Y') : '-'); ?></span>
                        </div>
                    </div>

                    <div class="student-footer">
                        <div class="student-badges">
                            <span class="status-badge <?php echo e($student->jenis_kelamin == 'L' ? 'bg-blue-100 text-blue-800' : 'bg-pink-100 text-pink-800'); ?>">
                                <?php echo e($student->jenis_kelamin == 'L' ? 'L' : 'P'); ?>
                            ...
                            <?php else: ?>
                                <span class="status-badge bg-gray-100 text-gray-800"><?php echo e(ucfirst($student->status)); ?></span>
                            <?php endif; ?>
                        </div>
        ...
        <?php if($siswa->count() > 0): ?>
            <div class="px-6 py-4 border-t border-gray-200 bg-gray-50">
                <div class="text-sm text-gray-600">
                    Menampilkan <?php echo e($siswa->count()); ?> dari <?php echo e($totalSiswa); ?> siswa dalam kelas yang Anda ajar
                </div>
            </div>
        <?php endif; ?>
    </div>
    ...
    return {
        async exportData() {
            try {
                ...
                const response = await fetch(`<?php echo e(route('guru.siswa.export')); ?>?${params.toString()}`, {
                    method: 'GET',
                    headers: {
...
<?php echo $__env->make('layouts.guru', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\website-smk3\resources\views/guru/siswa/index.blade.php ENDPATH**/ ?>