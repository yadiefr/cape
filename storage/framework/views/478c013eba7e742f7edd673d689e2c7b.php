    ...
    <header>
        <div class="container-custom header-container">
            ...
            <ul class="nav-menu">                
                ...
                <li><a href="<?php echo e(route('pendaftaran.index')); ?>" class="cta-button">Daftar PPDB</a></li>
            ...
            <div class="hero-grid">
                ...
                <?php if($activeBanner): ?>
                    <div class="hero-content" data-aos="fade-right" data-aos-duration="1000">
                        <div class="hero-badge">
                            <i class="fas fa-check-circle"></i> <?php echo e($activeBanner->subtitle); ?>
                ...
                <?php else: ?>
                    <div class="hero-content" data-aos="fade-right" data-aos-duration="1000">
                        ...
                        <h1 class="hero-title">Siapkan Masa Depan Kamu Di <span><?php echo e(setting('nama_sekolah')); ?></span></h1>
                        <p class="hero-description"><?php echo e(setting('site_description', 'SMK PGRI CIKAMPEK menyediakan pendidikan yang relevan dengan kebutuhan industri teknologi saat ini, didukung oleh fasilitas terbaik dan pengajar profesional untuk mengembangkan potensi siswa.')); ?></p>
                        <div class="hero-cta">
                            <a href="<?php echo e(route('pendaftar.register')); ?>" class="hero-cta-primary">Daftar Sekarang</a>
                            <a href="#programs" class="hero-cta-secondary">
                                <i class="fas fa-play-circle"></i> <span class="d-none d-sm-inline">Jelajahi </span>Program
                            </a>
                        </div>
                    ...
                    <div class="gallery-overlay">
                        <div class="gallery-info">
                            ...
                            <div class="gallery-actions">
                                <button class="gallery-view-btn" onclick="openSimpleGalleryModal(<?php echo e($item->id); ?>, '<?php echo e(str_replace("'", "\\'", $item->judul)); ?>', '<?php echo e(str_replace("'", "\\'", $item->deskripsi)); ?>')" title="Lihat semua foto">
                                    <i class="fas fa-images"></i>
                                </button>
                                <a href="<?php echo e(asset('uploads/galeri/' . $item->gambar)); ?>" class="gallery-zoom" target="_blank" title="Perbesar foto utama">
    ...
    <section class="social-media-section">
        <div class="container-custom text-center">
            ...
            <div class="social-icons">
                ...
                <a href="<?php echo e(setting('facebook_url')); ?>" target="_blank" class="social-icon">
                    <i class="fab fa-facebook-f"></i>
                </a>
                <?php endif; ?>
                
                <?php if(setting('instagram_url')): ?>
                <a href="<?php echo e(setting('instagram_url')); ?>" target="_blank" class="social-icon">
                    <i class="fab fa-instagram"></i>
                </a>
                <?php endif; ?>
                
                <?php if(setting('youtube_url')): ?>
                <a href="<?php echo e(setting('youtube_url')); ?>" target="_blank" class="social-icon">
                    <i class="fab fa-youtube"></i>
                </a>
                <?php endif; ?>
                
                <?php if(setting('whatsapp_number')): ?>
                <a href="https://wa.me/<?php echo e(setting('whatsapp_number')); ?>" target="_blank" class="social-icon">
