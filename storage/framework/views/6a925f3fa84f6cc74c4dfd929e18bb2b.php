                  ...
                  <div class="collapse navbar-collapse" id="navbarPPDB">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <?php else: ?>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('pendaftar.register')); ?>">Daftar</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('pendaftar.login')); ?>">Login</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link <?php echo e(request()->routeIs('pendaftaran.check') ? 'active' : ''); ?>" href="<?php echo e(route('pendaftaran.check')); ?>">Cek Status</a>
                            </li>
                        <?php endif; ?>
                    </ul>
                </div>
