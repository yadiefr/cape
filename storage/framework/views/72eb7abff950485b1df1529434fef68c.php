...
<?php $__env->startSection('title', 'Informasi Keuangan'); ?>
        ...
        <div class="bg-purple-50 rounded-lg p-3 sm:p-4 lg:p-6 border border-purple-100 hover:shadow-md transition-shadow">
            <div class="flex flex-col lg:flex-row lg:items-center">
                ...
                <div class="lg:ml-4 text-center lg:text-left">
                    ...
                    <p class="text-sm sm:text-lg lg:text-2xl font-bold text-purple-900">Rp <?php echo e(number_format($totalTagihan, 0, ',', '.')); ?></p>
        ...
        <div class="bg-green-50 rounded-lg p-3 sm:p-4 lg:p-6 border border-green-100 hover:shadow-md transition-shadow">
            <div class="flex flex-col lg:flex-row lg:items-center">
                ...
                <div class="lg:ml-4 text-center lg:text-left">
                    ...
                    <p class="text-sm sm:text-lg lg:text-2xl font-bold text-green-900">Rp <?php echo e(number_format($totalTelahDibayar, 0, ',', '.')); ?></p>
        ...
        <div class="bg-red-50 rounded-lg p-3 sm:p-4 lg:p-6 border border-red-100 hover:shadow-md transition-shadow">
            <div class="flex flex-col lg:flex-row lg:items-center">
                ...
                <div class="lg:ml-4 text-center lg:text-left">
                    ...
                    <p class="text-sm sm:text-lg lg:text-2xl font-bold text-red-900">Rp <?php echo e(number_format($totalTunggakan, 0, ',', '.')); ?></p>
        ...
        <div class="bg-blue-50 rounded-lg p-3 sm:p-4 lg:p-6 border border-blue-100 hover:shadow-md transition-shadow">
            <div class="flex flex-col lg:flex-row lg:items-center">
                ...
                <div class="lg:ml-4 text-center lg:text-left">
                    ...
                    <p class="text-sm sm:text-lg lg:text-2xl font-bold text-blue-900"><?php echo e($totalTunggakan <= 0 ? 'Lunas' : 'Belum Lunas'); ?></p>
                    <p class="text-xs text-blue-600 mt-1"><?php echo e(date('d/m/Y')); ?></p>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php $__empty_1 = true; $__currentLoopData = $detailTagihan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tagihan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    Rp <?php echo e(number_format($tagihan['total_dibayar'], 0, ',', '.')); ?>

                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    Rp <?php echo e(number_format($tagihan['sisa'], 0, ',', '.')); ?>

                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm">
                                    <span class="px-2 py-1 text-xs leading-5 font-semibold rounded-full 
                                        <?php echo e($tagihan['status'] === 'Lunas' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                                        <?php echo e($tagihan['status']); ?>

                                    </span>
                                </td>
                                <td class="px-6 py-4 text-sm font-medium">
                                    <?php if($tagihan['status'] !== 'Lunas' && $tagihan['sisa'] > 0): ?>
                                        <div class="flex flex-col space-y-2">
                                            <div class="flex items-center space-x-2">
                                                <input 
                                                    type="number" 
                                                    id="amount-<?php echo e($tagihan['id']); ?>"
                                                    class="w-24 px-2 py-1 text-xs border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                                    min="1000"
                                                    max="<?php echo e($tagihan['sisa']); ?>"
                                                    placeholder="Nominal">
                                                <button 
                                                    ...
                                                    data-siswa-id="<?php echo e(auth('siswa')->id()); ?>"
                                                    data-tagihan-id="<?php echo e($tagihan['id']); ?>"
                                                    data-max-amount="<?php echo e($tagihan['sisa']); ?>">
                                            ...
                                            <small class="text-gray-500 text-xs">
                                                Min: Rp 1.000 | Max: Rp <?php echo e(number_format($tagihan['sisa'], 0, ',', '.')); ?>
        ...
        <div class="p-6">
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php $__empty_1 = true; $__currentLoopData = $allPembayaran; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pembayaran): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td class="px-6 py-4 text-sm text-gray-900">
                                    <?php echo e($pembayaran->keterangan ?? ($pembayaran->tagihan ? ($pembayaran->tagihan->nama_tagihan ?? $pembayaran->tagihan->nama) : 'Pembayaran')); ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    <?php echo e($pembayaran->metode_pembayaran ?? 'Manual'); ?>

                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="px-2 py-1 text-xs leading-5 font-semibold rounded-full 
                                        <?php echo e($pembayaran->status === 'lunas' ? 'bg-green-100 text-green-800' : 'bg-blue-100 text-blue-800'); ?>">
                                        <?php echo e(ucfirst($pembayaran->status ?? 'Lunas')); ?>
...
<?php echo $__env->make('layouts.siswa', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\website-smk3\resources\views/siswa/keuangan/index.blade.php ENDPATH**/ ?>