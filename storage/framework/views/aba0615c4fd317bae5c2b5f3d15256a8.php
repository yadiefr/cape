...
<?php $__env->startSection('title', 'Penilaian - SMK PGRI CIKAMPEK'); ?>
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="mt-4 sm:mt-0 flex items-center space-x-3">
                <div class="flex items-center px-3 py-2 bg-blue-50 rounded-lg">
                    ...
                    <span class="text-sm font-medium text-blue-700"><?php echo e($kelas->count()); ?> Kelas</span>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="nilai-card bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                <div class="flex items-start justify-between mb-4">
                    <div class="flex-1 min-w-0">
                        <h3 class="text-lg font-bold text-gray-900 truncate"><?php echo e($k->nama_kelas ?? 'Kelas Tidak Diketahui'); ?></h3>
                        <p class="text-sm text-gray-600 mt-1 truncate"><?php echo e($k->jurusan->nama_jurusan ?? $k->jurusan->nama ?? 'Jurusan Tidak Diketahui'); ?></p>
                    </div>
                ...
                <div class="grid grid-cols-2 gap-3 mb-4">
                    <div class="text-center p-3 bg-gray-50 rounded-lg">
                        <div class="text-xl font-bold text-gray-900"><?php echo e($k->siswa ? $k->siswa->count() : 0); ?></div>
                        <div class="text-xs text-gray-600">Siswa</div>
                    </div>
                    <div class="text-center p-3 bg-gray-50 rounded-lg">
                        <div class="text-xl font-bold text-gray-900"><?php echo e($k->mapel_count ?? 0); ?></div>
                        <div class="text-xs text-gray-600">Mapel</div>
                    </div>
                </div>
                
                <?php if(isset($k->taught_mapels) && $k->taught_mapels->count() > 0): ?>
                    <div class="mb-4">
                        <p class="text-sm font-medium text-gray-700 mb-2">Mata Pelajaran:</p>
                        <div class="flex flex-wrap gap-1">
                            <?php $__currentLoopData = $k->taught_mapels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mapel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <span class="inline-block px-2 py-1 bg-blue-50 text-blue-700 text-xs rounded">
                                    <?php echo e($mapel->nama ?? 'N/A'); ?>
                    ...
                    <div class="space-y-2">
                        <?php if($k->taught_mapels->count() == 1): ?>
                            
                            <a href="<?php echo e(route('guru.nilai.create', ['kelas_id' => $k->id, 'mapel_id' => $k->taught_mapels->first()->id])); ?>" 
                        ...
                        <?php else: ?>
                            ...
                            <a href="<?php echo e(route('guru.nilai.show', $k->id)); ?>" 
                               class="w-full bg-blue-500 hover:bg-blue-600 text-white text-center py-2 px-4 rounded-lg transition-colors text-sm font-medium block">
...
<?php $__env->stopPush(); ?> 
<?php echo $__env->make('layouts.guru', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\website-smk3\resources\views/guru/nilai/index.blade.php ENDPATH**/ ?>