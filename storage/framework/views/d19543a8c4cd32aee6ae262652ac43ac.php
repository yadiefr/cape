...
<?php $__env->startSection('title', 'Detail Penilaian - SMK PGRI CIKAMPEK'); ?>
    ...
    <div class="header-section flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-4">
        <div>
            <h1 class="text-xl sm:text-2xl font-bold text-gray-800 mb-2">
                Penilaian Kelas <?php echo e($kelas->nama_kelas ?? 'Tidak Diketahui'); ?>
        ...
        <a href="<?php echo e(route('guru.nilai.index')); ?>" class="bg-gray-100 hover:bg-gray-200 text-gray-700 py-2 px-4 rounded-lg transition-colors text-center sm:text-left">
        ...
        <div class="p-5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="mapel-card border border-gray-200 rounded-lg p-4 hover:border-blue-500 hover:shadow-md transition-all">
                    <h3 class="font-medium text-gray-800"><?php echo e($m->nama ?? 'Mata Pelajaran Tidak Diketahui'); ?></h3>
                    <p class="text-sm text-gray-500 mb-3"><?php echo e($m->kode_mapel ?? $m->kode ?? 'Tidak ada kode'); ?></p>
                    
                    <div class="space-y-3">
                        
                        <a href="<?php echo e(route('guru.nilai.create', ['kelas_id' => $kelas->id, 'mapel_id' => $m->id])); ?>"
                        ...
                        <a href="<?php echo e(route('guru.nilai.show', $kelas->id)); ?>?action=detail&mapel_id=<?php echo e($m->id); ?>" 
...
<?php echo $__env->make('layouts.guru', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\website-smk3\resources\views/guru/nilai/show.blade.php ENDPATH**/ ?>